...
- **Easy switching**: Quickly toggle between duo column and grid view via tabs
...
After enabling the module, access the duo column dashboard via URL:

```
https://your-icinga-server/icingaweb2/duocolumn/dashboard
```

### Switching Between Views

- When viewing the duo column dashboard, click the **"Grid View"** tab to return to the normal grid layout
- All your existing dashboard panes are available via the tabs
